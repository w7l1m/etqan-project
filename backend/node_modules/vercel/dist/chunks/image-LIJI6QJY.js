...
async function image(client, argv, telemetry) {
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-TFOKQKY3.js")).default(client, args, telemetry);
    case "inspect":
      return (await import("./inspect-3SEYQNWT.js")).default(client, args, telemetry);
    case "rm":
      return (await import("./rm-XJMPAJNP.js")).default(client, args, telemetry);
    default:
