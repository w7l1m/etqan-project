...
async function rules(client, argv) {
  if (argv.length === 0 || argv[0].startsWith("-")) {
    const lsFn = (await import("./ls-HN3SUOPA.js")).default;
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-HN3SUOPA.js")).default(client, args);
    case "add":
      return (await import("./add-YRFK663I.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-BJGXMAO5.js")).default(client, args);
    case "rm":
      return (await import("./rm-MPC5DPOS.js")).default(client, args);
    case "update":
      return (await import("./update-55OM2454.js")).default(client, args);
    default:
